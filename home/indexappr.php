...
<meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="stylebut.css">
    ...
    <link rel="stylesheet" href="styleindexappr.css">
</head>
                        ...
                        <div class="roww" ;>
                          ...
                          <div class="col-md-8 col-sm-12">
                            ...
                            <div class="col-md-4 col-sm-12 text-right">
                                <a href="insertappro.php" class="btn btn-small btn-primary">Ajouter Un approvisionnement</a>
                            </div>
                        </div>
...
<?php
        ...
        $stmt=$conn->query("select * from appro");
     echo "<table class=","table table-hover table-striped tm-table-striped-even mt-3"," >";
     echo "<tr class=","tm-bg-gray",">";
    //  echo "<th scope=","col",">&nbsp;</th>";
     echo" <th scope=","col",">ID</th>";
     echo" <th scope=","col",">DATE</th>";
     echo" <th scope=","col",">ID DE FOURNISSEUR</th>";
     echo" <th scope=","col"," class=","text-center",">NOM DE FOURNISSEUR</th>";
     echo" <th scope=","col",">AJOUT D'UN PRODUIT</th>";
     echo"</tr>";
     echo"</thead>";
     echo   "</tr>";
while ($row =$stmt->fetch()) {     
        ...
        // echo" <th scope=","row",">";
        // echo"</th>";
        echo"<td class=","tm-product-name",">".$row['ida']."</td>";
        echo "<td class=","text-center",">".$row['datea']."</td>";
        $cat_idf=$row['idf'];
        $req4 = $conn->prepare("SELECT * FROM fournisseur WHERE idf=$cat_idf ");
        $req4->execute();
        $row2 = $req4->fetch();
        echo "<td class=","text-center",">".$row['idf']."</td>";
        echo "<td>".$row2['nomf']."</td> ";
        echo" <td>";
        echo "<a href=","details_appro.php?ida=".$row['ida']."","><i class='las la-shopping-cart'></i></a>";
         echo"</td>" ;
        // echo " </tr>";
        echo"</tbody>";
}
