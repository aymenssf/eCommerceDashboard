...
<body>
    ...
    <div class="sidebar">
        ...
        <input type="radio" name="s" id="Fournisseurs" checked>
                    ...
                    <div class="bg-white tm-block h-100">
                        <div class="roww">
                            ...
                            <div class="col-md-4 col-sm-12 text-right">
                                <a href="insertfournisseur.php" class="btn btn-small btn-primaryfour">Ajouter Un fournisseur</a>
                            </div>
                        </div>
...
echo "<table class=","table table-hover table-striped tm-table-striped-even mt-3"," >";
    ...
    //  echo "<th scope=","col",">&nbsp;</th>";
     ...
     while($row =$stmt->fetch(PDO::FETCH_NUM))  {     
        ...
        echo" <td>";
        echo "<a href=","updatefournisseur.php?idf=".$row['0']."","><i class='las la-edit'></i></a>";
         echo"</td>" ;
        echo" <td>";
        echo "<a href=","deletefournisseur.php?idf=".$row['0']."","><i class='las la-trash-alt'></i></a>";
         echo"</td>" ;
        echo " </tr>";
        echo"</tbody>";
}
